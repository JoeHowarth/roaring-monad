...
Cross-request immutable artifact caching is a separate architectural concern and is covered only as an assumption and dependency here. The active plan lives at:
